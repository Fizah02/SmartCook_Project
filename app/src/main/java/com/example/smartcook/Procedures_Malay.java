...
public class Procedures_Malay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Recipes").child("Malay").child(recipeId).child("procedure");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Procedures_Malay.this, Ingredients_Malay.class);
