...
public class Feedback_Malay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        feedbackReference = FirebaseDatabase.getInstance().getReference().child("Recipes").child("Malay").child(recipeId).child("feedbacks");
        ...
        feedbackReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Feedback_Malay.this, "Failed to retrieve feedback data", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Feedback_Malay.this, Ingredients_Malay.class);
