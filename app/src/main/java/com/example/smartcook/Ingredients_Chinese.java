...
public class Ingredients_Chinese extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Recipes").child("Chinese").child(recipeId).child("ingredients");
        ...
        recipeRef = FirebaseDatabase.getInstance().getReference().child("Recipes").child("Chinese").child(recipeId);
        ...
        startCookingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Ingredients_Chinese.this, Procedures_Chinese.class);
        ...
        commentButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Ingredients_Chinese.this, Feedback_Chinese.class);
                intent.putExtra("recipeId", recipeId);
                startActivity(intent);
            }
        });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Ingredients_Chinese.this, BottomTab.class);
        startActivity(intent);
