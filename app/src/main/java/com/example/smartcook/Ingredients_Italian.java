...
public class Ingredients_Italian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Recipes").child("Italian").child(recipeId).child("ingredients");
        ...
        recipeRef = FirebaseDatabase.getInstance().getReference().child("Recipes").child("Italian").child(recipeId);
        ...
        startCookingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Ingredients_Italian.this, Procedures_Italian.class);
        ...
        commentButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Ingredients_Italian.this, Feedback_Italian.class);
                intent.putExtra("recipeId", recipeId);
                startActivity(intent);
            }
        });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Ingredients_Italian.this, BottomTab.class);
        startActivity(intent);
