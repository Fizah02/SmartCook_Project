...
public class Ingredients_Indian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Recipes").child("Indian").child(recipeId).child("ingredients");
        ...
        startCookingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Ingredients_Indian.this, Procedures_Indian.class);
        ...
        commentButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Ingredients_Indian.this, Feedback_Indian.class);
                intent.putExtra("recipeId", recipeId);
                startActivity(intent);
            }
        });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Ingredients_Indian.this, BottomTab.class);
        startActivity(intent);
