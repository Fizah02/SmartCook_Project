...
public class Feedback_Korean extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        feedbackReference = FirebaseDatabase.getInstance().getReference().child("Recipes").child("Korean").child(recipeId).child("feedbacks");
        ...
        feedbackReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Feedback_Korean.this, "Failed to retrieve feedback data", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Feedback_Korean.this, Ingredients_Korean.class);
