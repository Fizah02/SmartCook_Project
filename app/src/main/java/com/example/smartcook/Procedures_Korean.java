...
public class Procedures_Korean extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Recipes").child("Korean").child(recipeId).child("procedure");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Procedures_Korean.this, Ingredients_Korean.class);
