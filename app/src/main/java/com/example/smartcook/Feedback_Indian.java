...
public class Feedback_Indian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        feedbackReference = FirebaseDatabase.getInstance().getReference().child("Recipes").child("Indian").child(recipeId).child("feedbacks");
        ...
        feedbackReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Feedback_Indian.this, "Failed to retrieve feedback data", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Feedback_Indian.this, Ingredients_Indian.class);
