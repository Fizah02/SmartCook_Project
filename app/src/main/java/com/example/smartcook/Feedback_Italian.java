...
public class Feedback_Italian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        feedbackReference = FirebaseDatabase.getInstance().getReference().child("Recipes").child("Italian").child(recipeId).child("feedbacks");
        ...
        feedbackReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Feedback_Italian.this, "Failed to retrieve feedback data", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Feedback_Italian.this, Ingredients_Italian.class);
