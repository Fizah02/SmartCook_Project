...
public class Procedures_Chinese extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Recipes").child("Chinese").child(recipeId).child("procedure");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Procedures_Chinese.this, Ingredients_Chinese.class);
