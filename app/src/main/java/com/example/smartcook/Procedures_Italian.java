...
public class Procedures_Italian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Recipes").child("Italian").child(recipeId).child("procedure");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Procedures_Italian.this, Ingredients_Italian.class);
